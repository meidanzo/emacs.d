...
(when (file-exists-p (expand-file-name "~/.local/share/emacs-rime"))
  (defcustom rime-share-data-dir "~/.local/share/emacs-rime"
    "The directory containing rime dictionaries."
    :type 'directory
    :group 'rime)

  (defcustom rime-user-data-dir "~/.local/share/emacs-rime"
    "The directory containing rime dictionaries."
    :type 'directory
    :group 'rime))
...
(with-eval-after-load 'rime
  ...
  ;; ㄓ: modeline
  (add-to-list 'my-extra-mode-line-info
               '(:eval (rime-lighter))
               t)
  ...
  (if (display-graphic-p)
    ...
    (my-popup-style-setup))     ;; 终端环境：使用popup
